...
public class CollectionsExercise {
    ...
    static void arrayList() {
        ...
        boolean containsMouse = animals.contains("mouse");
        System.out.println(containsMouse);

        boolean containsHorse = animals.contains("horse");
        System.out.println(containsHorse);
    ...
    static void linkedList() {
        ...
        System.out.println(animals.indexOf("mouse"));
